...
describe('Circle', () => {
    ...
    describe('Render', () => {
        it('should return the render string', () => {
            const circle = new Circle('blue');
            expect(circle.render()).toBe('<circle cx="50%" cy="50%" r="75" fill="blue" stroke="black" stroke-width="2"/>')
        });
    });
});
...
describe('Triangle', () => {
    ...
    describe('Render', () => {
        it('should return the render string', () => {
            const triangle = new Triangle('blue');
            expect(triangle.render()).toBe('<polygon points="75,175 150,25 225,175" fill="blue" stroke="black" stroke-width="2"/>')
        });
    });
});
...
describe('Square', () => {
    ...
    describe('Render', () => {
        it('should return the render string', () => {
            const square = new Square('blue');
            expect(square.render()).toBe('<rect x="25%" y="25" width="150" height="150" fill="blue" stroke="black" stroke-width="2"/>')
        });
    });
});
